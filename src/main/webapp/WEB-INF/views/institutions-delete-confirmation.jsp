...
<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <!-- End of Topbar -->
      <h1>Are you sure you want to delete "${institution.name}"?</h1>
      <form:form modelAttribute="institution" method="post" action="/admin/institutions/delete">
        <form:input path="name" class="form-control" aria-describedby="name" autocomplete="true" type="hidden"/>
        <form:input path="description" class="form-control" autocomplete="true" type="hidden"/>
        <form:input path="id" type="hidden" autocomplete="true"/>
        <form:button type="submit" class="btn btn-danger">Delete</form:button>
        <a href="${pageContext.request.contextPath}/admin/institutions" class="btn btn-info">Cancel</a>
      </form:form>
      <!-- End of Main Content -->
