...
<%--            <form:checkboxes path="categories" items="${donation.categories}"/>--%>
          ...
          <div data-step="2">
            ...
            <div class="form-group form-group--inline">
              <label>
                Liczba 60l worków:
                <form:input path="quantity" type="number" name="bags" step="1" min="1" id="formQuantity" />
              </label>
            </div>
            ...
            <div class="summary">
              <div class="form-section">
                ...
                <ul>
                  <li>
                    ...
                    <span class="summary--text" id="donationQuantity"
                      ></span
                    >
                  </li>
                  ...
                  <li>
                    ...
                    <span class="summary--text" id="donationInstitution"
              ...
              <div class="form-section form-section--columns">
                <div class="form-section--column">
                  <h4>Adres odbioru:</h4>
                  <ul>
                    <li id="donationStreet">Prosta 51</li>
                    <li id="donationCity">Warszawa</li>
                    <li id="donationZipCode">99-098</li>
                    <li id="donationPhoneNumber">123 456 789</li>
                  </ul>
                </div>
                ...
                <div class="form-section--column">
                  <h4>Termin odbioru:</h4>
                  <ul>
                    <li id="donationPickUpDate">13/12/2018</li>
                    <li id="donationPickUpTime">15:40</li>
                    <li id="donationDescription">Brak uwag</li>
                  </ul>
                </div>
              </div>
            </div>
